...
- Course/domain concepts: skills/feedback/references/course_concepts.md (if available - enhances assumption validation)
...
4. (Recommended) Add `skills/feedback/references/course_concepts.md` with domain concepts to enhance assumption validation
